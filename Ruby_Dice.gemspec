Gem::Specification.new do |gem|
  ...
  gem.email = "zenitram.oiram@gmail.com", "zrp200@gmail.com"
  gem.bindir = "bin"
...
DIS
  ...
  gem.authors = "Mario Martinez", "Zachary Perlmutter"
  gem.add_development_dependency "rspec", ">= 3.1"
  gem.add_development_dependency "rspec-its"
  gem.homepage = "https://rubygems.org/gems/Ruby_Dice/#{gem.version}"
  gem.license = "MIT"
  gem.required_ruby_version = ">= 1.9.2"
  gem.requirements << "Git Bash"
end
